...
$(function () {
    $('.ox__second').html('<div class="ox__inputs">\
                    <div class="ox__form-group">\
                        <div class="ox__form-label">Ваше имя</div>\
                        <input type="text" id="name" class="ox__form-control">\
                    </div>\
                    <div class="ox__form-group">\
                        <div class="ox__form-label">Ваша фамилия</div>\
                        <input type="text" id="surname" class="ox__form-control">\
                    </div>\
                    <div class="ox__form-group">\
                        <div class="ox__form-label">Ваш год рождения</div>\
                        <select name="year" id="year" class="ox__form-control">\
                    ...
                    <div class="ox__form-group">\
                        <div class="ox__form-label">Время рождения</div>\
                        <select class="ox__form-control" id="vremya">\
                            <option value="1" selected="">Утро (с 06:00 до 12:00)</option>\
                            <option value="2">День (с 12:00 до 18:00)</option>\
                            <option value="3">Вечер (с 18:00 до 00:00)</option>\
                            <option value="4">Ночь (с 00:00 до 06:00)</option>\
                        </select>\
                    </div>\
                    <div class="ox__form-group  ox__form-big">\
                        <div class="ox__form-label">Ваш город рождения</div>\
                        <select class="ox__form-control" id="city">\
                            <option value="Абаза" selected="">Абаза</option>\
                    ...
                    <div class="ox__form-group">\
                        <div class="ox__form-label">Дата рождения отца</div>\
                        <input type="text" id="papa" class="ox__form-control">\
                    </div>\
                    <div class="ox__form-group">\
                        <div class="ox__form-label">Дата рождения матери</div>\
                        <input type="text" id="mama" class="ox__form-control">\
                    </div>\
                </div>\
                <div class="btns do_btns">\
                    <div class="ox__btn" id="start">Узнать результат</div>\
                </div>');
    Inputmask({regex: "[A-я]*"}).mask('#name, #surname');
    $('#papa, #mama').inputmask("99.99.9999");
    ...
    $('#start').click(function (e) {
        ...
        var papa = $('#papa').val();
        var mama = $('#mama').val();
        if (zodiak && imya && surname && papa && mama) {
            sendAjaxForm('result_form', 'ajax_form', '/ox_gad/goroskop/goroskop-zhizni/js/text.php');
            return false;
        } else if (!zodiak || !imya || !surname || !papa || !mama) {
            Swal.fire({
                type: 'error',
                title: 'Упс!',
...
function sendAjaxForm(result_form, ajax_form, url) {
    ...
    function showRezult(selected_card) {
        ...
        var MyDate = $('#zodiak').attr('data-date');
//        console.log(result);
        var showHtml = '<div class="rezult-list"> \
                            <div class="rezult-list__cardtitle">' + result.surname + ' ' + result.name + ' - индивидуальный гороскоп жизни</div>\
                            <div class="rezult-list__info"> \
                                <div class="rezult-list__pic">\
                                    ...
                                    <div class="rezult-list__desc">' + MyDate + '</div>\
                                </div>\
