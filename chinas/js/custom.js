...
$(function () {
    $('.ox__formcontrol').change(function () {
        ...
        $(this).closest('.ox__people').find('img').attr('src', '/ox_gad/goroskop/chinas/img/' + tr + '.jpg');
    });
    $('#start').click(function (e) {
        ...
        if (here && she) {
            sendAjaxForm('result_form', 'ajax_form', '/ox_gad/goroskop/chinas/js/text.php');
            return false;
        }
    });
                        ...
                        <div class="rezult-list__info"> \
                            <div class="rezult_people">\
                            	<div class="rezult_people__item">\
                            		<img src="/ox_gad/goroskop/chinas/img/' + result.here + '.jpg">\
                            		<div class="rezult_people__title">' + result.answer.he + '</div>\
                            	</div>\
                            	<div class="rezult_people__item">\
                            		<img src="/ox_gad/goroskop/chinas/img/' + result.she + '.jpg">\
